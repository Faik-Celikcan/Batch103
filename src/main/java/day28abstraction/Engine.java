...
public interface Engine {
   ...
   2.8 - Abstract class constructor`a sahiptir    */
    ...
    //interfaceler'deki tum methodlar "abstract" olmak zorundadir.
    //interfaceler'de method abstract method olustururken "abstract" keyword kullanmaya gerek yoktur. Cunku java
    //o method'un abstract oldugunu bilir.

    //interfaceler'deki method'lar java tarafindan otomatik olarak "public" kabul edilir. Bu yuzden o methodlar icin
